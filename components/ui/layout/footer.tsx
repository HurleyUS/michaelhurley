...
export default function Footer() {
  return (
    <footer id="bottom" role="contentinfo" className="*:text-sm text-center shrink">
      <p>Made with ❤️ in Canton, NC</p>
      <p>
        <a href="https://www.hustlelaunch.com/">Website Design</a> by Hustle Launch,{" "}
        <a href="https://www.hurleyus.com/">Marketing</a> by HurleyUS
      </p>
      <p>
