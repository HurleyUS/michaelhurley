...
export function saveMichaelHurleyChatToStorage(messages: UIMessage[]): void {
...
export function clearMichaelHurleyChatStorage(): void {
  if (typeof window === "undefined") return;
  try {
    localStorage.removeItem(MICHAEL_HURLEY_CHAT_STORAGE_KEY);
  } catch {
    /* ignore */
  }
}
